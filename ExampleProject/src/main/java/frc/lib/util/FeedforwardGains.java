...
public class FeedforwardGains {
    ...
    /**
     * FeedforwardGains constructor is protected so that it can only be constructed through the use of the Builder
     * @param builder
     */
    ...
    /**
     * This class uses a Builder pattern to construct a FeedforwardGains
     * Each of the four feedforward gains have separate methods in the Builder.
     * This is a more explicit way of creating a data object with immutable data than using constructors.
     * The FeedforwardGains can be built by applying 0 or more of the gains values.
     */
