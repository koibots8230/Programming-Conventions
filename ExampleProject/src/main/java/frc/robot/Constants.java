...
public class Constants {
    ...
    public class DriveConstants {
        ...
        public static final FeedforwardGains FEEDFORWARD_GAINS = new FeedforwardGains.Builder().kv(0.0).build();

        public static final MotorConstants FRONT_LEFT_MOTOR_CONSTANTS =
                new MotorConstants(false, 60);
        public static final MotorConstants BACK_LEFT_MOTOR_CONSTANTS =
                new MotorConstants(false, 60);
        public static final MotorConstants FRONT_RIGHT_MOTOR_CONSTANTS =
                new MotorConstants(false, 60);
        public static final MotorConstants BACK_RIGHT_MOTOR_CONSTANTS =
                new MotorConstants(false, 60);
    ...
    public class IntakeConstants {
        ...
        public static final AngularVelocity SHOOTING_SPEED = RPM.of(300);
    ...
    public class TurretConstants {
        ...
        public static final AngularAcceleration MAX_ACCELERATION = RadiansPerSecondPerSecond.of(Math.PI * 18);
